...
<html>
  <head>
    ...
    <title>Haber Ekleme Sayfası</title>
    <!-- Tell the browser to be responsive to screen width -->
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
    <!-- Bootstrap 3.3.5 -->
    <link rel="stylesheet" href="bootstrap/css/bootstrap.min.css">
    <!-- Font Awesome -->
    <!--<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css">--><!-- değiştirilecek-->
    <!-- Ionicons -->
    <link rel="stylesheet" type="text/css" href="bootstrap/font-awesome-4.7.0/css/font-awesome.min.css">
    
   <link rel="stylesheet" type="text/css" href="bootstrap/ionicons-2.0.1/css/ionicons.min.css">
  <!--  <link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">--><!-- değiştirilecek-->
    <!-- fullCalendar 2.2.5-->
            ...
            <div class="col-md-12">
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Haber Ekleme Sayfası</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
 ...
 if(!empty($_POST["baslik"]) AND !empty($_POST["aciklama"]))
{
	...
	{ 		if ($_FILES["dosya"]["size"]<32*1024*1024)
	 ...
	 mysql_query("SET NAMES UTF8");
		$ekle=mysql_query(" INSERT INTO `haberler` (`HaberBaslik`, `HaberDetay`, `HaberResim`, `Tarih`, `WebLink`, `YayinlayanId`) VALUES('$y_bas', '$y_acik', '$yeni_ad', '$tarih', '$y_weblink', '$_SESSION[id]')");
								if ($ekle){
