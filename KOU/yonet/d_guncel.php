...
<html>
  <head>
    ...
    <title>Duyuru Güncelleme Sayfası</title>
            ...
            <div class="col-md-12">
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Duyuru Güncelleme Sayfası</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <div class="form-group">
				  <?php
					$g_id=$_GET['g_id'];
					$sorgu =mysql_query("SELECT * FROM `duyurular` WHERE DuyuruId='$g_id'");
 ...
 if(!empty($_POST["baslik"]) AND !empty($_POST["aciklama"]))
{
	...
	mysql_query("SET NAMES UTF8");
	$guncel=mysql_query("UPDATE `duyurular` SET `DuyuruTipi`='$y_tip',`Baslik`='$y_bas',`Aciklama`='$y_acik',`Ek`='$yeni_ad',`WebLink`='$y_weblink'  WHERE `DuyuruId`='$g_id'");
				 ...
				 <form method="POST" enctype='multipart/form-data' name="gunce" action="<?php $_SERVER['PHP_SELF']; ?>" >
                    <input class="form-control" name="baslik" value="<?php echo $dizi['Baslik'];?>"  placeholder="Başlık"/>
                  </div>
              ...
              Eklenme Tarihi Seçimi Sonradan iptal edilmiştir.
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="tip">
                    ...
                    <option value="bolum"<?php echo($dizi["DuyuruTipi"] == "bolum" ? 'selected' : '');  ?>>Bölüm</option>
